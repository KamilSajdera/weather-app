...
const endpoint = "http://api.geonames.org/searchJSON?name_startsWith=";
let cityList;
let cityDetails;
...
document.querySelector("#getUsrLocation").addEventListener('click', () => {
    ...
    geo.getCurrentPosition(function(location) {
        ...
        fetch(`http://api.geonames.org/findNearbyJSON?lat=${location.coords.latitude}&lng=${location.coords.longitude}&username=saydi`)
        .then(response => response.json())
        .then(data => {
